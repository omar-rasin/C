...
to bottom, let's index the matrix columns by numbers from 1 to 5 from left to right. In one move, you are allowed to apply one of the two 
...
int main() {
    ...
    //The third rows and third column is the center and is located at coordinates (2,2)

    int moves = abs(2-rows) + abs(2-cols);
